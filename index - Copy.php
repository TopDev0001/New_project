...
function init() {
    ...
    for (var i = 1; i <= 3; i++) {
        ...
        $('<div>' + words[i - 1] + '</div>').data('number', i).appendTo('#cardSlots').attr('id','cardSlots' + numbers[i])
    ...
    <section id="banner" class="back_section">
        ...
        <div class="container contain_div">
            ...
            <div id="content" class="row">
                ...
                <div class="col-sm-4 col-md-6 cardSlots_div ">
                ...
                <div class="col-sm-8 col-md-6 col-lg-6 text_div" style="text-align: center;">
                    ...
                    <div class="row_div">
                        ...
                        <div class="home_text4 row" id="home_text4" style="display: flex; align-items: center">

                            <div class="cream_image col-xs-12 col-sm-4" style="padding-left: 20px;">

                                <img src="img/tube.png">

                            </div>

                            <div class="cardPile_div col-xs-12 col-sm-2">

                                <div id="cardPile"> </div>

                            </div>

                            <div class="col-xs-12 col-sm-6 my-auto" style="display: flex; align-items: center;">
